...
**Companion documents:** Operationalises [[06_Frameworks/DPDP_Act_2023]] (if exists in vault — ⚠ VERIFY BEFORE PUBLISHING: confirm whether a standalone DPDP Act 2023 corpus/framework node already exists; this Rules node should link to it). No prior MeitY corpus nodes exist (MeitY folder previously empty) — this is the first MeitY entry.
...
**Related frameworks:** None yet in 06_Frameworks — ⚠ candidate for a future DPDP_Act_2023 framework node if not present
**Related projects:** [[02_Projects/P2_DPI_JSIS]] (primary), [[02_Projects/P3_BFSI_JEIM]] (SDF/BFSI overlap), [[01_Strategy/fsQCA]] (DPDP as a configurational element in comparative regulatory analysis)
