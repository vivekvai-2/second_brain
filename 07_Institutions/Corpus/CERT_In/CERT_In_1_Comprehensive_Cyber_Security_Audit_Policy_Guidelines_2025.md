...
**Related projects:** [[02_Projects/P1...]] (AI Governance SLR — operative vs. proposed AI-audit categories), [[02_Projects/P3_BFSI_JEIM]]/[[02_Projects/P4...]] (BFSI entities' cyber-audit obligations under CERT-In empanelment intersect with RBI/SEBI/IRDAI sectoral audit requirements), [[08_Methods/Institutional_Grammar_IG2]] (three-tier sign-off / maker-checker — strong ADICO candidate), [[01_Strategy/fsQCA]] (CERT-In as a "horizontal infrastructure" configurational variable distinct from "sectoral substantive AI provision" variables)
