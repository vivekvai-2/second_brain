...
| **India** | ~~draft circular + FREE-AI~~ **RBI_14 Draft Guidance on Model Risk Management, June 2026** (+ 2024 credit draft + FREE-AI) | **Inclusion by design, without binding force — updated 2026-08-09.** [[07_Institutions/Corpus/RBI/RBI_14_Draft_Guidance_Model_Risk_Management_2026]] is general-purpose, covers eleven RE categories, and carries a **dedicated AI/ML chapter** naming foundational and frontier models, generative AI, hallucination, prompt injection, red-teaming, drift, and automation bias. **On conceptual scope India is now ahead of the US** (which carves generative and agentic AI out) and at least level with the UK. On force it is behind all three: hortatory "should" throughout, draft, no stated legal basis. See the correction block below |
...
> ## 🔴 MATERIAL CORRECTION — 2026-08-09: a general-purpose Indian instrument now exists
>
> **[[07_Institutions/Corpus/RBI/RBI_14_Draft_Guidance_Model_Risk_Management_2026]]** — *Guidance on Regulatory Principles for Model Risk Management, 2026* (RBI, Department of Regulation, **June 2026, draft for public consultation**). The section below and the Confirmed Absences list are **superseded in part** and must be read against this.
>
> **What changes.** The finding "India has no single, general-purpose instrument equivalent to SR 26-2 or SS1/23" is no longer accurate as to **scope**. RBI_14 is:
>
> - **General-purpose** — all models, not credit models. Its definition is functional and use-based, capturing "algorithms, analytics, interfaces, applications, decision-based rules, and other computational tools… **irrespective of whether such tools are recognised as models by the RE**," with a worked illustration treating a spreadsheet loan-pricing calculator as a model once its output drives lending decisions.
> - **The widest perimeter of any AI-adjacent RBI instrument in the corpus** — eleven RE categories: Commercial Banks (incl. foreign), SFBs, Payments Banks, LABs, RRBs, Urban and Rural Co-operative Banks, NBFCs across **all four layers**, the five AIFIs, ARCs and CICs.
> - **Comprehensive** — governance (Board/RMCB/Senior Management), risk-based tiering, inventory, full lifecycle, third-party models, and a dedicated AI/ML chapter (paras 49–63).
> - **More AI-inclusive than either comparator.** SR 26-2 *excludes* generative and agentic AI from model-risk scope. RBI_14 names foundational models, frontier models, generative AI, hallucination, prompt injection, adversarial inputs, red-teaming, data drift, concept drift, automation bias — and makes autonomy a tiering factor (para 52: "the extent of reliance and the level of autonomy placed on the model outputs for decision-making").
>
> **What does not change, and is now better evidenced.** The instrument is **draft** and **hortatory** — "should" throughout, no SHALL, no penalty, no reporting obligation to RBI, no supervisory consequence in 64 paragraphs, and para 5 subordinates it to binding Directions in case of inconsistency. The note's existing diagnosis — *"India's problem here is bindingness, not conceptual scope"* — was correct and is now confirmed by a far stronger instance than the credit-scoped 2024 draft it rested on.
>
> **Corrected finding, stated precisely:** *India has a general-purpose model-risk instrument that is more AI-inclusive than the US or UK equivalents. It is in draft, it is hortatory, and it states no legal basis (⚠#334).*
>
> ⚠ Do not cite RBI_14 as operative. Track for notification — on notification the correction strengthens and the four-jurisdiction table below needs rebuilding.

## **India — ~~no equivalent exists~~ the absence had structure, and is now partly filled**
...
~~**The confirmed finding, stated precisely:** India has **no single, general-purpose, binding instrument equivalent to SR 26-2 or SS1/23**. What exists is (a) a **draft**, **credit-scoped** circular on traditional statistical model risk, and (b) a **non-binding Committee Report** extending model-governance language to AI.~~ **⚠ Superseded 2026-08-09 by RBI_14 — see the correction block above.**

**The finding, restated (2026-08-09):** India has **no general-purpose, *binding* instrument** equivalent to SR 26-2 or SS1/23. It now has a general-purpose **draft guidance** that is broader in perimeter and more AI-specified than either. Three instruments coexist: (a) [[07_Institutions/Corpus/RBI/RBI_14_Draft_Guidance_Model_Risk_Management_2026]] — general-purpose, AI-explicit, hortatory, draft; (b) the 2024 **credit-scoped** draft circular; (c) the **non-binding FREE-AI Committee Report**. **None is binding.** The structural difference from the US and UK is now singular rather than threefold: it is bindingness alone.

**A rare positive for India, now stronger.** On the *inclusion* question India is ahead of both comparators. SR 26-2 excludes generative and agentic AI outright; SS1/23 includes AI/ML only "to the extent that it applies to models more generally," without AI-specific provisions. RBI_14 devotes fifteen paragraphs (49–63) to AI/ML specifically, covering explainability thresholds, hallucination boundaries, fairness assessment, overfitting, spurious correlation, output variability, drift, red-teaming, prompt injection, customer disclosure, and a four-paragraph human-oversight regime. **India's problem here is bindingness, not conceptual scope** — the note's original diagnosis, now resting on much firmer ground and worth stating in [[P3_BFSI_JEIM]] in exactly those terms.
...
- **(2026-08-09) [[07_Institutions/Corpus/RBI/RBI_14_Draft_Guidance_Model_Risk_Management_2026]] — the new India anchor.** General-purpose draft Guidance, eleven RE categories, dedicated AI/ML chapter (paras 49–63), 10-year decommissioned-model retention (para 23), express refusal of third-party assurance reuse (para 46(i)), four-paragraph human-oversight regime (60–63) matching all five EU AI Act Art. 14(4) items and adding decision fatigue and a near-miss learning loop. **Hortatory throughout — no SHALL, no Or-else, no legal basis stated (⚠#334).** Supersedes RBI_13/RBI_3 as the note's primary India instrument
- [[07_Institutions/Corpus/RBI/RBI_13_Draft_Model_Risk_Credit_2024]] — the 2024 credit-scoped draft. ⚠ **Duplicate alert: this node and [[07_Institutions/Corpus/RBI/RBI_3]] are the same instrument** (5 Aug 2024, DOR.STR.REC./21.04.048/2024-25). Flagged 2026-08-09, not merged — see RBI_14's Log
...
- ~~No Indian general-purpose model-risk instrument.~~ **✅ RESOLVED 2026-08-09.** [[07_Institutions/Corpus/RBI/RBI_14_Draft_Guidance_Model_Risk_Management_2026]] is general-purpose, covers eleven RE categories, and is AI-explicit. **The absence that remains is narrower and should be stated as such: no Indian general-purpose *binding* model-risk instrument.** RBI_14 is draft and hortatory.
