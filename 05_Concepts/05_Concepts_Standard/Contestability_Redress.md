...
- **(2026-08-02, restated 2026-08-15 — contestability absence at the infrastructure layer)** [[07_Institutions/Corpus/NPCI/NPCI_1_AI_ML_Payments_Operations_2025_2026]] — ~~UPI's federated AI fraud-detection pilot generates cross-institutional risk scores~~ **NPCI's EFRM issues ecosystem-level fraud alerts that member banks are directed to act on with priority**, with **no identified contestability route** for a customer adversely affected (OQ-NPCI-03). Where the AA regime over-provides redress, the payments rail provides none. ⚠#361 — the alerting system is not evidenced as AI/ML-based, which does not weaken the contestability point.
- **(2026-08-15 — NEW, and sharper)** The one NPCI AI system named as live or piloted in a primary document is the **UPI Help Assistant**, a grievance-resolution SLM. **AI is deployed on the redress channel itself**, not on the decision — an AI mediating contestability is a distinct governance question from AI producing the contested outcome, and no Indian instrument addresses it. ⚠#362.

- **(2026-08-23 — a contestability-sensitive carve-out drawn by procedural posture)** [[07_Institutions/Corpus/CGPDTM/CGPDTM_1_AI_in_Patent_Examination_Guidelines_2026]] §5(f) — prohibits sole reliance on AI for decisions affecting the rights of applicants, patentees or third parties, “especially in arriving at conclusions in cases where situations involve opposing parties, for instance, opposition proceedings.” The instrument singles out ***inter partes*** proceedings for heightened treatment, drawing the line by procedural posture rather than by accuracy risk — the only instance in this list where contestability shapes an *ex ante* restriction on AI use rather than an *ex post* remedy. ⚠ Annexure-II (Checklist and declaration) is absent from the source (⚠#370), so whether an affected party can actually invoke the Guidelines is **unresolved** — see the P4 doctrinal questions on the node.
