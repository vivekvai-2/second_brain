...
- (Ad hoc, 2026-08-09 — **the construct's first express regulatory refusal, not an inference from silence**) [[07_Institutions/Corpus/RBI/RBI_14_Draft_Guidance_Model_Risk_Management_2026]] para 46(i) requires third-party models to undergo independent validation by the RE *"**notwithstanding any validation, certification, or assurance provided by the third-party provider**."* Every other instance in this note is an *absence* — regulators failing to provide for reuse, with the gap inferred from silence. **This is a regulator affirmatively excluding reliance on external assurance in the instrument text.** Reinforced by para 46(ii) (enhanced RMCB oversight of third-party models **irrespective of risk tier**) and para 48 (contracts must secure audit rights **for the RE and its supervisory authority**, directly or via external experts) — assurance must be re-performable by the accountable party and its regulator, not accepted from the vendor. Converts the construct's central claim from an inference about regulatory silence into a documented regulatory choice, which is considerably harder to argue away. **Note the tension with [[06_Frameworks/ISO_IEC_42001]]:** a market in AI management-system certificates is expanding while the regulator that matters most for Indian BFSI has pre-emptively declined to treat such certificates as discharging validation. ⚠ Draft instrument, hortatory ("should") — the refusal is a stated posture, not yet an enforceable one.
- (Ad hoc, 2026-08-09 — **within-instrument variant**, first non-BFSI instance) [[07_Institutions/Corpus/CEA/CEA_3_Cyber_Security_Power_Sector_Regulations_2026]] — the canonical Indian instance recorded above is a *four-cycle stack assembled across four regulators*. CEA_3 produces a three-cycle stack **inside a single instrument**: annual cyber security audit (reg 13; 9–15 month window; no three consecutive audits by the same agency or personnel), ISO/IEC 27001 or Technical Criteria Certificate certification audit (reg 5(24); no four consecutive audits by the same agency), and annual self-audit (reg 15) — each with distinct scope, cadence, rotation rule and retention horizon (3 / 4 / 3 years), and **no provision permitting any one to satisfy any other**. Entities that are also Protected Systems carry NCIIPC's validated control regime on top (reg 7(3)(d)); those in scope of CERT-In's empanelment regime carry that auditor-selection constraint as well (reg 3(1)(p)). The auditor-rotation bars are notable in their own right — they *forbid* the continuity that would make cross-cycle reuse operationally easier, so the instrument actively raises the cost of the very reuse the concept says is absent. Extends the construct from a cross-regulator to an **intra-instrument** phenomenon and out of BFSI for the first time.
- (Ad hoc, 2026-08-09 — **within-regulator divergence between model assurance and data assurance**) [[07_Institutions/Corpus/RBI/RBI_16_Draft_Guidance_Data_Governance_2026]] Ch. VI (paras 60–63) requires audit of third-party data-sharing arrangements — "need to know" access, non-disclosure clauses, secure channels, periodic audit via CERT-IN empanelled auditors — but contains **no equivalent to RBI_14 para 46(i)'s express "notwithstanding any validation, certification, or assurance provided by the third-party provider."** Same department (DoR.ORG.REC), instruments issued roughly one month apart: an express refusal of vendor assurance for third-party **models**, ordinary oversight language for third-party **data**. Whether this is a considered distinction — models plausibly carry more decision-consequential risk than the underlying data-sharing arrangement — or an unconsidered drafting inconsistency cannot be determined from either text. Recorded as a **within-regulator** instance of the gap, distinct from every prior instance in this note, which are all cross-regulator.
...
**Cross-reference (2026-08-15).** A second instance of the same structure was recorded the same day at [[05_Concepts/05_Concepts_Standard/Orchestration_Governance]]: Microsoft ships approval gates, RBAC-controlled workflow modification and replayable orchestration telemetry as product features, with **no regulator requiring any of it and no supervisory visibility into whether it is enabled**. Certification assurance in India and runtime controls in a hyperscaler product are different layers, but the shape is identical — **governance capability supplied ahead of, and without, governance obligation**. Provisional label **supply-side governance surplus**; two instances only, gate not met (⚠#368).
